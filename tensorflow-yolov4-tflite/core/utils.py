...
def draw_bbox(image, bboxes, classes=read_class_names(cfg.YOLO.CLASSES), show_label=True):
    ...
    image_transparent = np.zeros(image.shape, dtype=np.uint8)
    ...
    for i in range(num_boxes[0]):
        ...
        # ----------------------- Added by me (Hugo) ------------------------------------
        _image_transparent = np.zeros(image.shape, dtype=np.uint8)
        cv2.rectangle(_image_transparent, c1, c2, bbox_color, -1)

        image_transparent = cv2.addWeighted(image_transparent, 1, _image_transparent, 0.5, 0.0)
        # ----------------------- Added by me (Hugo) ------------------------------------
    ...
    # ----------------------- Added by me (Hugo) ------------------------------------
    image = cv2.addWeighted(image, 0.8, image_transparent, 0.4, 0.0)
    # ----------------------- Added by me (Hugo) ------------------------------------
    return image
