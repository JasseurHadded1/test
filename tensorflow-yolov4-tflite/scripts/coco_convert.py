...
flags.DEFINE_string('input', '../data/full_data/train/annotations_train_coco.json', 'path to classes file')
flags.DEFINE_string('output', 'annotations_train_coco.pkl', 'path to classes file')
                ...
                for info in images_info:
                        if info["id"] == image_id:
                            filename, img_width, img_height = \
                                '.'.join(info["file_name"].split(".")[:-1]), info["width"], info["height"]
